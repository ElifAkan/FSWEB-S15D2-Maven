...
public class StringSet {
    public static Set<String> findUniqueWords() {
        String text ="Carroll began writing the manuscript of the story the next day," +
                ...
                "another boat trip a month later, when he elaborated the plot to the story of Alice," +
                " and in November he began working on the manuscript in earnest. To add the finishing " +
                "touches he researched natural history in connection with the animals presented in" +
                " the book and then had the book examined by other children—particularly those of " +
                "George MacDonald. Though Carroll did add his own illustrations to the original copy, " +
                "on publication he was advised to find a professional illustrator so the pictures " +
                ...
                "On 26 November 1864, Carroll gave Alice the manuscript of Alice's Adventures Under Ground, " +
                "with illustrations by Carroll, dedicating it as A Christmas Gift to a Dear Child in Memory of a Summer's Day." +
                "The published version of Alice's Adventures in Wonderland is about twice the length of Alice's " +
                "Adventures Under Ground and includes episodes, such as the Mad Tea-Party, that did not appear " +
                "in the manuscript. The only known manuscript copy of Under Ground is held in the British Library. " +
